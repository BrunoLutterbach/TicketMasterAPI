...
@ActiveProfiles("test")
public class EnderecoControllerE2ETest {
    ...
    void shouldUpdateEndereco() {
        RestAssured.given()
                ...
                .body("{\"logradouro\":\"Rua Teste Atualizada\",\"cep\":\"28640000\",\"numero\":\"21\",\"cidade\":\"Carmo\"}")
                .when()
                .put("/api/endereco/" + enderecoId)
                .then()
                .statusCode(200)
                .body("logradouro", equalTo("Rua Teste Atualizada"));
    }
}
